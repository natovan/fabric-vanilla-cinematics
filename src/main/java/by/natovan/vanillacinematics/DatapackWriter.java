...
public class DatapackWriter {
    ...
    public void initDatapack() {
        ...
        try {
            ...
            FileWriter tickWriter = new FileWriter(datapacksPath + VC_TAGS_FUNC_PATH + "tick.json");
            tickWriter.write("{\"values\":[\"" + VC_MODID + ":main\"]}");
            tickWriter.close();

            FileWriter loadWriter = new FileWriter(datapacksPath + VC_TAGS_FUNC_PATH + "load.json");
            loadWriter.write("{\"values\":[\"" + VC_MODID + ":load\"]}");
            loadWriter.close();

            FileWriter mainFuncWriter = new FileWriter(datapacksPath + VC_TAGS_FUNC_PATH + "main.mcfunction");
            ...
            FileWriter loadFuncWriter = new FileWriter(datapacksPath + VC_TAGS_FUNC_PATH + "load.mcfunction");
    ...
    public void deleteDatapack() {
        ...
        if (server != null) {
            String datapacksPath = server.getSavePath(WorldSavePath.DATAPACKS).toString();
            try {
                FileUtils.deleteDirectory(new File(datapacksPath + "\\" + VC_CAMEL_SPACED));
                wasInitiated = false;
            } catch (IOException e) {
